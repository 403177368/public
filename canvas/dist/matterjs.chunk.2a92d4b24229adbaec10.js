	...
	createObjects: function createObjects() {
		...
		var trip = Bodies.polygon(this.w / 2, this.h / 2, 100, 70, {
			render: {
				...
				opacity: 0.8,
				sprite: {
					texture: __webpack_require__(23)(this.imgDir + 'trip.png'),
					xScale: 0.5,
					yScale: 0.5
				}
			},
		...
		var Prague = Bodies.polygon(500, 100, 100, 50, {
			render: {
				...
				lineWidth: 3,
				sprite: {
					texture: __webpack_require__(25)(this.imgDir + 'Prague.png')
				}
			},
			density: Math.random() * 0.1,
			isStatic: false,
		...
		var Yunnan = Bodies.polygon(500, 100, 100, 50, {
			render: {
				...
				lineWidth: 3,
				sprite: {
					texture: __webpack_require__(27)(this.imgDir + 'Yunnan.png')
				}
			},
			density: Math.random() * 0.1,
			isStatic: false,
		...
		var France = Bodies.polygon(500, 100, 100, 50, {
			render: {
				...
				lineWidth: 3,
				sprite: {
					texture: __webpack_require__(29)(this.imgDir + 'France.png')
				}
			},
			density: Math.random() * 0.1,
			isStatic: false,
